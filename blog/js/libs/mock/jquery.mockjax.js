...
(function(root, factory) {
	...
	function _xhrSend(mockHandler, requestSettings, origSettings) {
		...
		if ( mockHandler.proxy ) {
			var _url=mockHandler.proxy;
			if(_util.isObject(mockHandler.proxy))
			{

				if(origSettings.data&&origSettings.data["_proxyKey"])
				{
					_url=mockHandler.proxy[origSettings.data["_proxyKey"]];
				}
			}
