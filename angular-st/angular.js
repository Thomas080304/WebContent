...
function publishExternalAPI(angular){
  ...
  try {
    ...
    //queue.push(['$provide','provide',arguments]);
    //arguments = ['$locale', $LocaleProvider]
  }
  //queue.push(['$injector', 'invoke',arguments]);
  //arguments = [['$provide',function(){}]]
  var tt = angularModule('ng', ['ngLocale'], ['$provide',
    ...
    forEach(modulesToLoad, function(module) {
      ...
      function runInvokeQueue(queue) {
        ...
        for(i = 0, ii = queue.length; i < ii; i++) {
          var invokeArgs = queue[i];//["$provide","provider",Arguments[2]]
          var provider = providerInjector.get(invokeArgs[0]);//$provide
          //cache['$provide']
